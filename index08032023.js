    ...
    var trial = {
        ...
        on_finish: function(data) {
            ...
            $.getJSON(fileName, function(target_file_data) {
                ...
                // Added these lines to relocate messages and targets during the practice trials
                var practice_mess_loc = [(screen_width / 2), (screen_height/3)]
                var practice_target_loc = [(target_x2-target_radius/2 + screen_width/4), (target_y-target_radius/2 + screen_height/6)]
                ...
                svgContainer.append('svg:image')
                    .attr('x', practice_target_loc[0])
                    .attr('y', practice_target_loc[1])
                    .attr('width', target_radius)
                    .attr('height', target_radius)
               ...
               //cursor
                ...
                svgContainer.append('text')
                    ...
                    .attr('x', practice_mess_loc[0])
                    .attr('y', practice_mess_loc[1] - line_size)
                    .attr('fill', 'white')
                ...
                svgContainer.append('text')
                    .attr('text-anchor', 'middle')
                    .attr('x', practice_mess_loc[0])
                    .attr('y', practice_mess_loc[1] + 2*line_size)
                    .attr('fill', 'white')
                    .attr('font-family', 'sans-serif')
                    .attr('font-size', message_size)
                ...
                svgContainer.append('text')
                    .attr('text-anchor', 'middle')
                    .attr('x', practice_mess_loc[0])
                    .attr('y', practice_mess_loc[1] + 3*line_size)
                    .attr('fill', 'white')
                    .attr('font-family', 'sans-serif')
                    .attr('font-size', message_size)
