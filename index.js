        ...
        $.getJSON(fileName, function(target_file_data) {
           ...
           //cursor
            ...
            svgContainer.append('text')
                .attr('text-anchor', 'middle')
                .attr('x', screen_width / 2)
                .attr('y', screen_height / 2 - line_size * 10)
                .attr('fill', 'white')
                .attr('font-family', 'sans-serif')
                .attr('font-size', message_size)
                .attr('id', 'practice_trial_message_1')
                .attr('display', 'none')
                .text('Filler');
            ...
            svgContainer.append('text')
                .attr('text-anchor', 'middle')
                .attr('x', screen_width / 2)
                .attr('y', screen_height / 2 - line_size * 9)
                .attr('fill', 'white')
                .attr('font-family', 'sans-serif')
                .attr('font-size', message_size)
                .attr('id', 'practice_trial_message_2')
                .attr('display', 'none')
                .text('Filler2');
            ...
            function search_phase() {
                ...
                d3.select('#practice_trial_message_1').attr('fill', 'white').attr('display', 'none');
                d3.select('#practice_trial_message_2').attr('fill', 'white').attr('display', 'none');
            ...
            function fb_phase() {
                ...
                // } else if (practice_trial == true) {
                //     if (trial <= 2) { // practice trials to denote accuracy
                //         if (correct_resp[trial] == 1) {
                //             if (trial == 1) {
                //
                //             }
                //         }
                ...
                } else if (practice_trial[trial] == true) {
                    practice_trial_feedback();
                          ...
                          if (cursor_x < start_x) {
                              participant_category_resp = "A"
                                  if (hand_fb_angle > angle_sens && hand_fb_angle < (180 - angle_sens)) {
                                      ...
                                      reach_feedback = "good_reach";
                                      d3.select('#feedback_circleL').attr('display', 'block').attr('stroke', 'green');
                                      d3.select('#practice_trial_message_1').attr('display', 'block').attr('fill', 'green').text('Nice guess!');
                                      d3.select('#practice_trial_message_2').attr('display', 'block').attr('fill', 'green').text("Green means you've made the correct choice!");
                                  } else if (correct_resp[trial] == 2) {
                                      reach_feedback = "good_reach";
                                      d3.select('#feedback_circleL').attr('display', 'block').attr('stroke', 'red');
                                      d3.select('#practice_trial_message_1').attr('display', 'block').attr('fill', 'red').text('Too bad!');
                                      d3.select('#practice_trial_message_2').attr('display', 'block').attr('fill', 'red').text("Red means you've made the incorrect choice.");
                                  }
